export const TRANSLATIONS_EN = {
  ...
  Profile: {
    ...
    leaveModal: {
      ...
      confirm: "Leave",
      cancel: "Cancel",
      success: "Left band successfully!",
      successDescription: "You have left the band.",
      errorDescription: "Could not leave the band.",
    },
    kickModal: {
      title: "Kick member",
  ...
  Invites: {
    ...
    errorCreatingMembership: "Oops! Could not add artist",
    successCreatingInvite: "Invite created successfully!",
    successCreatingMembership: "Artist added to band successfully!",
    noInvites: "You don't have any invitations yet. Keep up the good work!",
    Accepted: "Congratulations!",
    AcceptedDescription: "You are now part of the band",
    Rejected: "We understand",
