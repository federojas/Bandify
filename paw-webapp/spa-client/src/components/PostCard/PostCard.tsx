...
export default function PostCard() {
  return (
    ...
    <img
    style={{ width: "50px", height: "50px", objectFit: "cover", borderRadius: "1000px",border:"2px solid black" }}
     src="https://cdn-1.motorsport.com/images/amp/6O1P1km2/s1000/jos-verstappen-1.jpg"></img>
    ...
    <div style={{marginLeft:"20px"}}>
      ...
      <PostCardAuditionTitle>Se busca baterista para la banda</PostCardAuditionTitle>
      </div>
    {/* --------------------------------------------  */}
    ...
    {/* ---------- Location roles and genres ------- */}
      <ul>
        {/* LOCATION */}
        <li style={{display:"flex", flexDirection:"row", justifyContent:"space-between", alignItems:"center"}}>
