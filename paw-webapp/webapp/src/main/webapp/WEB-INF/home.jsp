        ...
        <div class="home-div-2">
            ...
            <div class="home-div-4">
                <form:form modelAttribute="auditionForm" action="${postPath}" method="post">
                    ...
                    <div>
                        <form:label class="home-form-label-2" path="location">
                            Ubicación
                        </form:label>
                        <form:input type="location" class="home-form-input-2" path="location"/>
                    ...
                    <div>
                        ...
                        <form:select class="home-form-select-0" path="musicGenres" multiple="true">
                            <form:option value="rock">
                                Rock
                            </form:option>
                            <form:option value="cumbia">
                                Cumbia
                            </form:option>
                        </form:select>
                    </div>
                    <div>
                        ...
                        <form:select class="home-form-select-1" path="lookingFor" multiple="true">
                            <form:option value="guitarrista">
                                Guitarrista
                            </form:option>
                            <form:option value="baterista">
                                Baterista
                            </form:option>
                        </form:select>
                    </div>
