...
>
    ...
    <div>
        ...
        <form:input type="password"  maxlength="50" placeholder="${passwordplaceholder}" class="form-input" path="password" />
    ...
    <div>
        ...
        <form:input type="text"  maxlength="50" placeholder="${surnameplaceholder}" class="form-input" path="surname" />
