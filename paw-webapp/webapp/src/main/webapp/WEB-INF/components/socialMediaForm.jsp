...
<html>
    ...
    <body>
        <form:label path="socialMedia" class="form-label"><spring:message code="media.form.title"/></form:label>
        ...
        <div  id="socialMediaContainer" class="social-media-form">
            ...
            <div class="social-media-input-container">
                ...
                <div class="social-media-input">
                    ...
                    <spring:message code="media.form.twitter.placeholder" var="twitterplaceholder" />
                    <form:input type="text" id="artistSurname" maxlength="2083" placeholder="${twitterplaceholder}" class="form-input" path="twitterUrl"/>
            ...
            <div class="social-media-input-container">
                ...
                <div class="social-media-input">
                    ...
                    <spring:message code="media.form.facebook.placeholder" var="facebookplaceholder" />
                    <form:input type="text" id="artistSurname" maxlength="2083" placeholder="${facebookplaceholder}"
                                class="form-input"
                                path="facebookUrl"/>
            ...
            <div class="social-media-input-container">
                ...
                <div class="social-media-input">
                    ...
                    <spring:message code="media.form.instagram.placeholder" var="instagramplaceholder" />
                    <form:input type="text" id="artistSurname" maxlength="2083" placeholder="${instagramplaceholder}"
                                class="form-input"
                                path="instagramUrl"/>
            ...
            <div class="social-media-input-container">
                ...
                <div class="social-media-input">
                    ...
                    <spring:message code="media.form.youtube.placeholder" var="youtubeplaceholder" />
                    <form:input type="text" id="artistSurname" maxlength="2083" placeholder="${youtubeplaceholder}"
                                class="form-input"
                                path="youtubeUrl"/>
            ...
            <div class="social-media-input-container">
                ...
                <div class="social-media-input">
                    ...
                    <spring:message code="media.form.spotify.placeholder" var="spotifyplaceholder" />
                    <form:input type="text" id="artistSurname" maxlength="2083" placeholder="${spotifyplaceholder}"
                                class="form-input"
                                path="spotifyUrl"/>
            ...
            <div class="social-media-input-container">
                ...
                <div class="social-media-input">
                    ...
                    <spring:message code="media.form.soundcloud.placeholder" var="soundcloudplaceholder" />
                    <form:input type="text" id="artistSurname" maxlength="2083" placeholder="${soundcloudplaceholder}"
                                class="form-input"
                                path="soundcloudUrl"/>
